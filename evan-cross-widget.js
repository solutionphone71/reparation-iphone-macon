(function(){
  ...
  style.textContent=`
    ...
    @media(max-width:720px){.sp-sebastien-mini{display:none}.sp-sebastien-launch span:last-child{display:none}.sp-sebastien-mini.conversation .sp-sebastien-panel{position:fixed;inset:8px 8px 74px;width:auto}.sp-sebastien-mini.conversation .sp-sebastien-frame{height:calc(100% - 50px)}}`;
